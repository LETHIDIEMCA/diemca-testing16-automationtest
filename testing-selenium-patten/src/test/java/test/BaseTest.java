...
public class BaseTest {
     ...
     private  static  final ThreadLocal<WebDriverWait> waitThreadLocalThreadLocal = new ThreadLocal<>();
     ...
     protected  WebDriverWait getWait (){
         return waitThreadLocalThreadLocal.get();
     }
    ...
    public void setUp(@Optional("chrome") String browser , @Optional ("")String device , Method method) throws IOException {
         ...
         // TODO :tạo folder chưa screenshot,video record

        // screenshot
        // B1: lay tên function lam ten folder testcase
        ...
        waitThreadLocalThreadLocal.set(wait);
   // TODO :Start recording
    ...
    @AfterMethod(alwaysRun = true)
     public void  tearDown (ITestResult result){
        ...
        waitThreadLocalThreadLocal.remove();
     }
}
