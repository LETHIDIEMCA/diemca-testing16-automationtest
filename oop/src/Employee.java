...
// class cha chỉ được dùng để class con kế thừa nên thêm tu khoa abstract
public abstract class Employee {

    // nhung thuoc tinh cua class BAT BUPC de privete
    private String ID;
     private String name;
     private int basicSalary;
     private String phuCap;

     // getter , setter dùng để lấy hàm về vì private
    ...
    public void setID(String ID) {
        // kiem tra kiue du liue khac string loi
        this.ID = ID;
    }
    ...
    public  Employee(){
     ...
     public  void showInfor (){
         ...
         // hàm truu tuong
         // bat buoc CLass con phải define lại hàm này
         // hàm này k có thân hàm là ngoac nhọn
